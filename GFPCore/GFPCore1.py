...
class GFPCore1(GFPCore):
    ...
    def acquireGainBais(sensorType,year,bId,satparams):
        ...
        """
        _Gain = satparams["Parameter"]['GF1'][sensorType][year]["gain"][bId-1]
        _Bias = satparams["Parameter"]['GF1'][sensorType][year]["offset"][bId-1] 
        return _Gain,_Bias

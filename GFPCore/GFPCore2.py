...
class GFPCore2(GFPCore):
    ...
    @staticmethod
    def acquireGainBais(sensorType,year,bId,satparams):
        """获取定标参数
        ...
        """
        _Gain = satparams["Parameter"]['GF2'][sensorType][year]["gain"][bId-1]
        _Bias = satparams["Parameter"]['GF2'][sensorType][year]["offset"][bId-1] 
        return _Gain,_Bias
...
def main():
    ...
    _tifpath = r'E:\GFDATA1\test\GF2_PMS1_E78.4_N33.9_20180730_L1A0003360574\GF2_PMS1_E78.4_N33.9_20180730_L1A0003360574-PAN1.tiff'
    # _tifpath = r'E:\GFDATA1\test\GF1_PMS1_E100.7_N29.7_20201028_L1A0005226696\GF1_PMS1_E100.7_N29.7_20201028_L1A0005226696-PAN1.tiff'
    # GFPCore.initDatabase(SATPARAMS)
    gfpc = GFPCore2(_tifpath)
